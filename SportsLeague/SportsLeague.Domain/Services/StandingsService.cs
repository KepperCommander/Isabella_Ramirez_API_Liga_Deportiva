...
namespace SportsLeague.Domain.Services; public class StandingsService : IStandingsService

{
...

    {
        ...
        var matches = await _matchRepository.GetByTournamentAsync(tournamentId); var matchIds = matches.Select(m => m.Id).ToHashSet();
